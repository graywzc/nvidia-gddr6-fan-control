...
<section class="card full"><h2><span>Docker Logs</span><div><span class="drag-handle" title="Drag to reorder">⠿</span><button class="resize-btn" title="Toggle size">⊞ size</button></div></h2><div id="dockerLogs" class="docker-logs"></div></section>
</div>
